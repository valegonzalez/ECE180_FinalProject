...
# installed.
TCL_PREFIX='C:\ci\python_1510177095141\work\externals\tcltk64'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:\ci\python_1510177095141\work\externals\tcltk64\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:\ci\python_1510177095141\work\externals\tcltk64\lib\tcl85.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:\ci\python_1510177095141\work\externals\tcltk64\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:\ci\python_1510177095141\work\externals\tcltk64\lib tclstub85.lib'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='.\Release_AMD64_VC9\tclstub85.lib'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='C:\ci\python_1510177095141\work\externals\tcltk64\lib\tclstub85.lib'
